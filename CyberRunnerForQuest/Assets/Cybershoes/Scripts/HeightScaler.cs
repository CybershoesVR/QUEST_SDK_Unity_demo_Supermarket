...
namespace Cybershoes
{
    public class HeightScaler : MonoBehaviour
    {
        ...
        public void InitHeightScaler(Transform hmd)
        {
            InitHeightScaler(hmd, OVRManager.profile.eyeHeight);
        }
        ...
        public void InitHeightScaler(Transform hmd, Transform offsetObject, bool enableOnInit)
        {
            InitHeightScaler(hmd, offsetObject, OVRManager.profile.eyeHeight, enableOnInit);
        }
        ...
        /// <param name="targetCharacterHeight">The target height of the character.</param>
        /// <param name="enableOnInit">If true scaling will automatically start to be applied.</param>
        public void InitHeightScaler(Transform hmd, Transform offsetObject, float targetCharacterHeight, bool enableOnInit)
        {
            offsetTransform = offsetObject;

            InitHeightScaler(hmd, targetCharacterHeight);
